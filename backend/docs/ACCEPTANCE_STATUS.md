...
| **Phase 8.13** | ⏳ PENDING VERIFY | Inventory Deduction | `inventory.service.spec.ts` | Inventory deduction from kitchen task completion using actual_g, append-only ledger pattern |
