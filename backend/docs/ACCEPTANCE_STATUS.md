...
| **Phase 8.12** | ⏳ PENDING VERIFY | Kitchen Task Data Capture MVP | `kitchen.service.spec.ts` | Staff kitchen APIs for task listing, detail view, and actual usage/photos capture |
