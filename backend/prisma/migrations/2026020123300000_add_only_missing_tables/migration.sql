-- Migration: Add Only Missing Tables (skip existing ones)
-- Date: 2026-02-02
-- Description: This migration adds tables that are missing in production
--              (purchase_list, purchase_item, purchase_record, custom_recipe tables)
--              Tables diy_sheet and order_pricing_snapshot already exist and are skipped.
