  ...
  async save(purchaseRecord: PurchaseRecord): Promise<PurchaseRecord> {
    ...
    const saved = await this.prisma.purchaseRecord.upsert({
      ...
      update: {
        ...
        actualPackageSize: data.actualPackageSize,
        actualPackageUnit: data.actualPackageUnit,
        actualBaseQuantity: data.actualBaseQuantity,
        actualBaseUnit: data.actualBaseUnit,
