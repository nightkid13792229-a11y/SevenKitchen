<template>
  <view class="login-container">
    ...
    <view class="logo-section">
      ...
      <text class="app-slogan">旧版小程序迁移入口</text>
    </view>
    ...
    <view class="login-section">
      ...
      >
        <text v-if="!loading">登录并进入迁移</text>
      ...
      <view class="migration-note">
        <text>旧版小程序仅保留迁移确认入口。登录后将按新版授权流程同步历史资料。</text>
      </view>
...
const handleWechatLogin = async () => {
  ...
  try {
    ...
    if (response.code === 0) {
      ...
      if ((role === "STAFF" || role === "ADMIN") && needsProfileSetup) {
