  ...
  <view class="me-container">
    ...
    <view v-if="!isLoggedIn" class="not-logged-in">
      ...
      <view class="benefits-section">
        ...
        <view class="benefit-item">完成迁移后同步历史资料</view>
        <view class="benefit-item">前往新版继续使用</view>
      </view>
    </view>
    ...
    <view v-else class="logged-in">
      ...
      >
        <view>
          <text class="phone-bind-title">请尽快完成迁移确认</text>
          <text class="phone-bind-desc"
            >完成迁移后可同步历史资料与宠物信息。</text
          >
        </view>
        <text class="phone-bind-action">去确认</text>
      </view>
      ...
      <view class="mall-section">
        <view class="mall-section-header">
          <text class="mall-section-title">迁移与历史资料</text>
        ...
        <view class="mall-shortcuts">
          <view class="mall-shortcut mall-shortcut-cart" @tap="goToCart">
            ...
            <text class="shortcut-text">去迁移</text>
          </view>
          <view
          ...
          >
            ...
            <text class="shortcut-text">历史资料</text>
          </view>
          <view
          ...
          >
            ...
            <text class="shortcut-text">资料同步</text>
          </view>
          <view
          ...
          >
            ...
            <text class="shortcut-text">历史查看</text>
          </view>
          <view
          ...
          >
            ...
            <text class="shortcut-text">迁移说明</text>
          </view>
        </view>
      </view>
...
import { blockLegacyOrdering } from "../../utils/legacy-migration";
